...
parser.add_argument('--reward', type=float, default=8.5)
parser.add_argument('--alpha', type=float, default=0.5)
parser.add_argument('--beta', type=float, default=0.7)

args = parser.parse_args()

rs = RewardSampling(access_token='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', llm_dir=args.llm_dir, rm_dir=args.rm_dir, seed=args.seed)
